...
<header class="app-header navbar">
    ...
    <!-- <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ url('/img/logo.jpeg') }}" height="35"
             alt="Logo">
        <img class="navbar-brand-minimized" src="{{ url('/img/logo2.jpeg') }}"
             height="35" alt="Logo">
    </a> -->
...
<footer class="app-footer">
    <div>
        <a href="#"></a>
        <span>
            Creado por : <strong>ortizjesusrivas@gmail.com</strong>
        </span>
    </div>
    <div class="ml-auto">
        <span></span>
