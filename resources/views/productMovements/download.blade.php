                 ...
                 <div class="col-lg-12">
                     <div class="card">
                         <div class="card-header">
                             ...
                             <hr>
                             <form action="/download-movements" method="GET" id="date_form">
                                {{-- @csrf --}}
                                <div class="input-group">
                                    ...
                                    <button type="submit" id="ot" value="enviar" class="btn btn-primary">descargar</button>

                                </div>
                            </form>
                            <form action="/download-movements" method="GET" name="form" id="form" >
                                {{-- @csrf --}}
                            ...
                            <form action="/download-movements" method="GET" name="code_form" id="code_form" >
                                {{-- @csrf --}}
                                <div class="input-group mb-3">
